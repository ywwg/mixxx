...
if MASTER_SYNC_LAYOUT:
    button_mapping = {'spinknob':['eject','<normal/>'],
           ...
           'button2':{'red':['sync_enabled','<button/>'],  'orange':['XoneK2.LoopPlus','<Script-Binding/>'], 'green':['hotcue_2_activate','<button/>']},
           'button3':{'red':['XoneK2.Vinyl','<Script-Binding/>'], 'orange':['XoneK2.LoopMinus','<Script-Binding/>'],  'green':['hotcue_3_activate','<button/>']},
